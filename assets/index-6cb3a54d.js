var l1=Object.defineProperty;var i1=(v,c,n)=>c in v?l1(v,c,{enumerable:!0,configurable:!0,writable:!0,value:n}):v[c]=n;var e0=(v,c,n)=>(i1(v,typeof c!="symbol"?c+"":c,n),n),a1=(v,c,n)=>{if(!c.has(v))throw TypeError("Cannot "+n)};var kv=(v,c,n)=>{if(c.has(v))throw TypeError("Cannot add the same private member more than once");c instanceof WeakSet?c.add(v):c.set(v,n)};var Pc=(v,c,n)=>(a1(v,c,"access private method"),n);(function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))e(r);new MutationObserver(r=>{for(const t of r)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&e(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const t={};return r.integrity&&(t.integrity=r.integrity),r.referrerPolicy&&(t.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?t.credentials="include":r.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function e(r){if(r.ep)return;r.ep=!0;const t=n(r);fetch(r.href,t)}})();function t0(){}function X(v,c){for(const n in c)v[n]=c[n];return v}function qv(v){return v()}function wv(){return Object.create(null)}function p0(v){v.forEach(qv)}function Sc(v){return typeof v=="function"}function o0(v,c){return v!=v?c==c:v!==c||v&&typeof v=="object"||typeof v=="function"}function f1(v){return Object.keys(v).length===0}function Vv(v,...c){if(v==null){for(const e of c)e(void 0);return t0}const n=v.subscribe(...c);return n.unsubscribe?()=>n.unsubscribe():n}function Cv(v){let c;return Vv(v,n=>c=n)(),c}function y0(v,c,n){v.$$.on_destroy.push(Vv(c,n))}function l0(v,c,n,e){if(v){const r=Yv(v,c,n,e);return v[0](r)}}function Yv(v,c,n,e){return v[1]&&e?X(n.ctx.slice(),v[1](e(c))):n.ctx}function i0(v,c,n,e){if(v[2]&&e){const r=v[2](e(n));if(c.dirty===void 0)return r;if(typeof r=="object"){const t=[],o=Math.max(c.dirty.length,r.length);for(let l=0;l<o;l+=1)t[l]=c.dirty[l]|r[l];return t}return c.dirty|r}return c.dirty}function a0(v,c,n,e,r,t){if(r){const o=Yv(c,n,e,t);v.p(o,r)}}function f0(v){if(v.ctx.length>32){const c=[],n=v.ctx.length/32;for(let e=0;e<n;e++)c[e]=-1;return c}return-1}function $(v){const c={};for(const n in v)n[0]!=="$"&&(c[n]=v[n]);return c}function r0(v,c){const n={};c=new Set(c);for(const e in v)!c.has(e)&&e[0]!=="$"&&(n[e]=v[e]);return n}function Hv(v){const c={};for(const n in v)c[n]=!0;return c}function m0(v,c,n){return v.set(n),c}function zc(v){return v&&Sc(v.destroy)?v.destroy:t0}function m(v,c){v.appendChild(c)}function w(v,c,n){v.insertBefore(c,n||null)}function k(v){v.parentNode&&v.parentNode.removeChild(v)}function Kv(v,c){for(let n=0;n<v.length;n+=1)v[n]&&v[n].d(c)}function E(v){return document.createElement(v)}function W(v){return document.createTextNode(v)}function B(){return W(" ")}function G0(){return W("")}function p(v,c,n,e){return v.addEventListener(c,n,e),()=>v.removeEventListener(c,n,e)}function s1(v){return function(c){return c.preventDefault(),v.call(this,c)}}function Y(v,c,n){n==null?v.removeAttribute(c):v.getAttribute(c)!==n&&v.setAttribute(c,n)}const u1=["width","height"];function n0(v,c){const n=Object.getOwnPropertyDescriptors(v.__proto__);for(const e in c)c[e]==null?v.removeAttribute(e):e==="style"?v.style.cssText=c[e]:e==="__value"?v.value=v[e]=c[e]:n[e]&&n[e].set&&u1.indexOf(e)===-1?v[e]=c[e]:Y(v,e,c[e])}function d1(v,c){Object.keys(c).forEach(n=>{h1(v,n,c[n])})}function h1(v,c,n){const e=c.toLowerCase();e in v?v[e]=typeof v[e]=="boolean"&&n===""?!0:n:c in v?v[c]=typeof v[c]=="boolean"&&n===""?!0:n:Y(v,c,n)}function wc(v){return/-/.test(v)?d1:n0}function _1(v){let c;return{p(...n){c=n,c.forEach(e=>v.push(e))},r(){c.forEach(n=>v.splice(v.indexOf(n),1))}}}function g1(v){return v===""?null:+v}function m1(v){return Array.from(v.childNodes)}function Z0(v,c){c=""+c,v.data!==c&&(v.data=c)}function B0(v,c){v.value=c??""}function Ic(v,c,n,e){n==null?v.style.removeProperty(c):v.style.setProperty(c,n,e?"important":"")}function _c(v,c,n){for(let e=0;e<v.options.length;e+=1){const r=v.options[e];if(r.__value===c){r.selected=!0;return}}(!n||c!==void 0)&&(v.selectedIndex=-1)}function xv(v,c){for(let n=0;n<v.options.length;n+=1){const e=v.options[n];e.selected=~c.indexOf(e.__value)}}function p1(v){const c=v.querySelector(":checked");return c&&c.__value}let uc;function ac(v){uc=v}function Vc(){if(!uc)throw new Error("Function called outside component initialization");return uc}function b1(v){Vc().$$.on_mount.push(v)}function Qv(v,c){return Vc().$$.context.set(v,c),c}function Ec(v){return Vc().$$.context.get(v)}function C(v,c){const n=v.$$.callbacks[c.type];n&&n.slice().forEach(e=>e.call(this,c))}const cc=[],C0=[];let vc=[];const Oc=[],y1=Promise.resolve();let jc=!1;function k1(){jc||(jc=!0,y1.then(Zv))}function Cc(v){vc.push(v)}function I0(v){Oc.push(v)}const Nc=new Set;let J0=0;function Zv(){if(J0!==0)return;const v=uc;do{try{for(;J0<cc.length;){const c=cc[J0];J0++,ac(c),w1(c.$$)}}catch(c){throw cc.length=0,J0=0,c}for(ac(null),cc.length=0,J0=0;C0.length;)C0.pop()();for(let c=0;c<vc.length;c+=1){const n=vc[c];Nc.has(n)||(Nc.add(n),n())}vc.length=0}while(cc.length);for(;Oc.length;)Oc.pop()();jc=!1,Nc.clear(),ac(v)}function w1(v){if(v.fragment!==null){v.update(),p0(v.before_update);const c=v.dirty;v.dirty=[-1],v.fragment&&v.fragment.p(v.ctx,c),v.after_update.forEach(Cc)}}function C1(v){const c=[],n=[];vc.forEach(e=>v.indexOf(e)===-1?c.push(e):n.push(e)),n.forEach(e=>e()),vc=c}const bc=new Set;let K0;function M0(){K0={r:0,c:[],p:K0}}function L0(){K0.r||p0(K0.c),K0=K0.p}function b(v,c){v&&v.i&&(bc.delete(v),v.i(c))}function y(v,c,n,e){if(v&&v.o){if(bc.has(v))return;bc.add(v),K0.c.push(()=>{bc.delete(v),e&&(n&&v.d(1),e())}),v.o(c)}else e&&e()}function Wc(v){return(v==null?void 0:v.length)!==void 0?v:Array.from(v)}function x0(v,c){const n={},e={},r={$$scope:1};let t=v.length;for(;t--;){const o=v[t],l=c[t];if(l){for(const a in o)a in l||(e[a]=1);for(const a in l)r[a]||(n[a]=l[a],r[a]=1);v[t]=l}else for(const a in o)r[a]=1}for(const o in e)o in n||(n[o]=void 0);return n}function N0(v,c,n){const e=v.$$.props[c];e!==void 0&&(v.$$.bound[e]=n,n(v.$$.ctx[e]))}function j(v){v&&v.c()}function G(v,c,n){const{fragment:e,after_update:r}=v.$$;e&&e.m(c,n),Cc(()=>{const t=v.$$.on_mount.map(qv).filter(Sc);v.$$.on_destroy?v.$$.on_destroy.push(...t):p0(t),v.$$.on_mount=[]}),r.forEach(Cc)}function U(v,c){const n=v.$$;n.fragment!==null&&(C1(n.after_update),p0(n.on_destroy),n.fragment&&n.fragment.d(c),n.on_destroy=n.fragment=null,n.ctx=[])}function x1(v,c){v.$$.dirty[0]===-1&&(cc.push(v),k1(),v.$$.dirty.fill(0)),v.$$.dirty[c/31|0]|=1<<c%31}function _0(v,c,n,e,r,t,o=null,l=[-1]){const a=uc;ac(v);const i=v.$$={fragment:null,ctx:[],props:t,update:t0,not_equal:r,bound:wv(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(c.context||(a?a.$$.context:[])),callbacks:wv(),dirty:l,skip_bound:!1,root:c.target||a.$$.root};o&&o(i.root);let f=!1;if(i.ctx=n?n(v,c.props||{},(s,d,...u)=>{const h=u.length?u[0]:d;return i.ctx&&r(i.ctx[s],i.ctx[s]=h)&&(!i.skip_bound&&i.bound[s]&&i.bound[s](h),f&&x1(v,s)),d}):[],i.update(),f=!0,p0(i.before_update),i.fragment=e?e(i.ctx):!1,c.target){if(c.hydrate){const s=m1(c.target);i.fragment&&i.fragment.l(s),s.forEach(k)}else i.fragment&&i.fragment.c();c.intro&&b(v.$$.fragment),G(v,c.target,c.anchor),Zv()}ac(a)}class g0{constructor(){e0(this,"$$");e0(this,"$$set")}$destroy(){U(this,1),this.$destroy=t0}$on(c,n){if(!Sc(n))return t0;const e=this.$$.callbacks[c]||(this.$$.callbacks[c]=[]);return e.push(n),()=>{const r=e.indexOf(n);r!==-1&&e.splice(r,1)}}$set(c){this.$$set&&!f1(c)&&(this.$$.skip_bound=!0,this.$$set(c),this.$$.skip_bound=!1)}}const S1="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(S1);const $0=[];function A0(v,c=t0){let n;const e=new Set;function r(l){if(o0(v,l)&&(v=l,n)){const a=!$0.length;for(const i of e)i[1](),$0.push(i,v);if(a){for(let i=0;i<$0.length;i+=2)$0[i][0]($0[i+1]);$0.length=0}}}function t(l){r(l(v))}function o(l,a=t0){const i=[l,a];return e.add(i),e.size===1&&(n=c(r,t)||t0),l(v),()=>{e.delete(i),e.size===0&&n&&(n(),n=null)}}return{set:r,update:t,subscribe:o}}class z1{constructor(c,n,e,r,t,o){this.gl=c;const l=this.texture=c.createTexture();c.bindTexture(c.TEXTURE_2D,l),e=e??c.CLAMP_TO_EDGE,r=r??c.LINEAR,c.texParameteri(c.TEXTURE_2D,c.TEXTURE_WRAP_S,e),c.texParameteri(c.TEXTURE_2D,c.TEXTURE_WRAP_T,e),c.texParameteri(c.TEXTURE_2D,c.TEXTURE_MIN_FILTER,r),c.texParameteri(c.TEXTURE_2D,c.TEXTURE_MAG_FILTER,r),this.format=n??c.RGBA,this.internalFormat=o??c.RGBA,this.type=t??c.UNSIGNED_BYTE}bind(c){const n=this.gl;return c!=null&&c!=null&&n.activeTexture(n.TEXTURE0+c),n.bindTexture(n.TEXTURE_2D,this.texture),this}blank(c,n){const e=this.gl;return this.bind(),e.texImage2D(e.TEXTURE_2D,0,this.internalFormat,c,n,0,this.format,this.type,null),this}set(c,n,e){const r=this.gl;return this.bind(),c instanceof Array&&(this.type==r.FLOAT?c=new Float32Array(c):c=new Uint8Array(c)),n!=null&&e!=null?r.texImage2D(r.TEXTURE_2D,0,this.internalFormat,n,e,0,this.format,this.type,c):r.texImage2D(r.TEXTURE_2D,0,this.internalFormat,this.format,this.type,c),this}subset(c,n,e,r,t){const o=this.gl;return this.bind(),c instanceof Array&&(this.type==o.FLOAT?c=new Float32Array(c):c=new Uint8Array(c)),r!=null&&t!=null?o.texSubImage2D(o.TEXTURE_2D,0,n,e,r,t,this.format,this.type,c):o.texSubImage2D(o.TEXTURE_2D,0,n,e,this.format,this.type,c),this}copy(c,n,e,r){const t=this.gl;return t.copyTexImage2D(t.TEXTURE_2D,0,this.internalFormat,c,n,e,r,0),this}}class E1{constructor(c,n=null){this.gl=c,this.framebuffer=arguments.length==2?n:c.createFramebuffer(),this.renderbuffer=null}bind(){return this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.framebuffer),this}unbind(){return this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,null),this}attach(c,n=0){const e=this.gl;return n==0&&this.bind(),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+n,e.TEXTURE_2D,c.texture,0),this}attachDepth(c,n){const e=this.gl;return this.bind(),this.renderbuffer==null&&(this.renderbuffer=e.createRenderbuffer(),e.renderbufferStorage(e.RENDERBUFFER,e.DEPTH_COMPONENT16,c,n),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.RENDERBUFFER,this.renderbuffer)),this}}class T1{constructor(c,n){this.gl=c,this.buffer=c.createBuffer(),this.target=n??c.ARRAY_BUFFER,this.size=-1}bind(){return this.gl.bindBuffer(this.target,this.buffer),this}update(c,n){const e=this.gl;return c instanceof Array&&(c=new Float32Array(c)),n=n??e.DYNAMIC_DRAW,this.bind(),this.size!==c.byteLength?(e.bufferData(this.target,c,n),this.size=c.byteLength):e.bufferSubData(this.target,0,c),this}}class R1{constructor(c,n,e){this.gl=c;const r=c.createProgram();if(!r)throw new Error("Failed to create program");if(this.program=r,c.attachShader(r,this.makeShader(c.VERTEX_SHADER,n)),c.attachShader(r,this.makeShader(c.FRAGMENT_SHADER,e)),c.linkProgram(r),!c.getProgramParameter(r,c.LINK_STATUS))throw new Error(c.getProgramInfoLog(r)||"Failed to link program");this.vars={}}makeShader(c,n){const e=this.gl,r=e.createShader(c);if(!r)throw new Error("Failed to create shader");if(e.shaderSource(r,n),e.compileShader(r),e.getShaderParameter(r,e.COMPILE_STATUS))return r;throw new Error(e.getShaderInfoLog(r)||"Failed to compile shader")}use(){return this.gl.useProgram(this.program),this}uniform(c,n,e,r){if(this.vars[c]==null){const o=this.gl.getUniformLocation(this.program,c);if(!o)throw new Error(`Failed to locate uniform '${c}'`);this.vars[c]=o}const t=this.vars[c];if(c0.isArray(n)){const o=n,a="uniform"+(r||o.length)+(e?"i":"f")+"v";this.gl[a](t,o)}else if(typeof n=="number"||typeof n=="boolean")e?this.gl.uniform1i(t,n):this.gl.uniform1f(t,n);else throw new Error("Invalid uniform value: "+n);return this}matrix(c,n,e){if(this.vars[c]==null){const t=this.gl.getUniformLocation(this.program,c);if(!t)throw new Error(`Failed to locate uniform '${c}'`);this.vars[c]=t}const r="uniformMatrix"+Math.sqrt(n.length)+"fv";return this.gl[r](this.vars[c],!!e,n),this}uniformi(c,n){return this.uniform(c,n,!0)}attrib(c,n,e,r){const t=this.gl;return this.vars[c]==null&&(this.vars[c]=t.getAttribLocation(this.program,c)),n.bind(),t.enableVertexAttribArray(this.vars[c]),t.vertexAttribPointer(this.vars[c],e,t.FLOAT,!1,r??0,0),this}draw(c,n,e){const r=this.gl;if(e==null?r.drawArrays(c,0,n):r.drawElements(c,n,e,0),r.getError()!==r.NO_ERROR)throw new Error("WebGL rendering error");return this}disable(){for(const c in this.vars){const n=this.vars[c];this.vars.hasOwnProperty(c)&&typeof n=="number"&&this.gl.disableVertexAttribArray(n)}return this}}class c0{constructor(c,n){let e;if(c instanceof HTMLCanvasElement){e=c;const r=c0.getContext(c,n);r&&(c=r)}else e=c.canvas;this.gl=c,this.canvas=e,this.defaultFramebuffer=new c0.Framebuffer(this.gl,null)}static getContext(c,n,e){let r;try{r=c.getContext("webgl2",n||{})}catch{r=null}if(r==null&&!e)throw new Error("Could not create WebGL context.");return r}static looksLikeURL(c){return/\s/.exec(c)==null}static isArray(c){const n=Object.prototype.toString.apply(c,[]);return/ (Float(32|64)|Int(16|32|8)|Uint(16|32|8(Clamped)?))?Array]$/.exec(n)!=null}program(c,n,e){return c0.looksLikeURL(c)&&(c=c0.fetch(c)),c0.looksLikeURL(n)&&(n=c0.fetch(n)),e!=null&&(c=e(c),n=e(n)),new c0.Program(this.gl,c,n)}array(c,n){const e=this.gl,r=new c0.Buffer(e,e.ARRAY_BUFFER);return c!=null&&r.update(c,n??e.STATIC_DRAW),r}elements(c,n){const e=this.gl,r=new c0.Buffer(e,e.ELEMENT_ARRAY_BUFFER);return c!=null&&r.update(c,n??e.STATIC_DRAW),r}texture(c,n,e,r,t,o,l){const a=new c0.Texture(this.gl,n,e,r,t,o);return c!=null&&(l&&l.type==="ArrayBufferView"?a.set(c,l.width,l.height):a.set(c)),a}framebuffer(c){const n=new c0.Framebuffer(this.gl);return c!=null&&n.attach(c),n}}c0.Framebuffer=E1;c0.Texture=z1;c0.Program=R1;c0.Buffer=T1;c0.QUAD2=new Float32Array([-1,-1,1,-1,-1,1,1,1]);c0.fetch=function(v,c){const n=new XMLHttpRequest;return n.open("GET",v,!!c),c!=null&&(n.onload=function(){c(n.responseText)}),n.send(),n.responseText};function Jv(v,c){return[v[0]-c[0],v[1]-c[1]]}function Sv(v,c){return[v[0]+c[0],v[1]+c[1]]}function A1(v,c){return[c[0]*v,c[1]*v]}function Bc(v,c){return[c[0]/v,c[1]/v]}const zv=(v,c)=>(v%c+c)%c;function F1(v,c,n){return Math.min(Math.max(v,c),n)}function gc(v,c){return[zv(v[0],c[0]),zv(v[1],c[1])]}var Ev=`#version 300 es
